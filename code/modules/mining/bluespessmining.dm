...
/obj/machinery/mineral/bluespace_miner/process()
	...
	if(prob(10))
		materials.mat_container.insert_amount(25,MAT_BLUESPACE)
		materials.mat_container.insert_amount(25,MAT_DIAMOND)
		materials.silo_log(src, "Generated two very rare resources.")
	if(prob(30))
		materials.mat_container.insert_amount(100,MAT_URANIUM)
		materials.mat_container.insert_amount(100,MAT_TITANIUM)
		materials.mat_container.insert_amount(100,MAT_GOLD)
		materials.silo_log(src, "Generated three rare resources.")
	if(prob(60))
		materials.mat_container.insert_amount(190,MAT_PLASMA)
		materials.mat_container.insert_amount(190,MAT_SILVER)
