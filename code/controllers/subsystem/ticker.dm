...
/datum/controller/subsystem/ticker/proc/setup()
	...
	SEND_SOUND(world, sound(pick('sound/ai/welcome.ogg', 'face/sound/roundstart/n313.ogg', 'face/sound/roundstart/halo.ogg', 'face/sound/roundstart/goagain.ogg', 'face/sound/roundstart/cs.ogg', 'face/sound/roundstart/gameboy.ogg', 'face/sound/roundstart/ts2spawn.ogg'))) // hippie -- really should not be touching ticker, but it must be done.
