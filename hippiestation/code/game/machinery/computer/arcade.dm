...
/obj/machinery/computer/arcade/minesweeper/Initialize()
	...
	squareempty = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_empty")]"
	squareminehit = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_minehit")]"
	square1 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_1")]"
	square2 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_2")]"
	square3 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_3")]"
	square4 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_4")]"
	square5 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_5")]"
	square6 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_6")]"
	square7 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_7")]"
	square8 = "[icon2html('hippiestation/icons/arcade/minesweeper_tiles.dmi', world, "minesweeper_8")]"
	..()
...
/obj/machinery/computer/arcade/minesweeper/proc/custom_generation()
	playsound(loc, 'hippiestation/sound/arcade/minesweeper_menuselect.ogg', 50, 0, extrarange = -3, falloff = 10)	//Entered into the menu so ping sound
	if(rows < 4)
